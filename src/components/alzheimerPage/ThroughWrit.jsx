  ...
  return (
      <Tilt>
        ...
        >
          ...
          <img
            src='src/assets/rondy-stickers-hand-with-pencil.png'
            alt="web-development"
        ...
        <div className='flex flex-row-reverse '>
            <div>
                 <p className={`${styles.heroSubText} text-md`}>
                    Through &nbsp;
                  <span className='sm:block hidden'>Handwriting :</span>
                </p>
                 <p className={`${styles.sectionSubText} m-3 mt-7`}>Spiral/wave handwriting analysis is a promising tool for predicting 
                 Alzheimer's disease. Studies have found that changes in handwriting movements can indicate the presence of Alzheimer's disease, 
                 and analyzing spiral handwriting movements can detect changes in speed, pressure, and size. While further research is needed to fully understand its potential, 
